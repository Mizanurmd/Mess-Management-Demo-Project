...
/////////// Create Success Response here
	public static Response getSuccessResponse(HttpStatus status, String message, Object content) {
		return Response.builder().message(message).content(content).statusCode(status.value())
				.timestamp(new Date().getTime()).build();
...
//////////Create Success Response here
	public static Response getSuccessResponse(HttpStatus status, String message, Object content, int numberOfElement) {
		return Response.builder().message(message).numberOfElement(numberOfElement).statusCode(status.value())
				.timestamp(new Date().getTime()).build();
...
//////////Create Success Response here
	public static Response getSuccessResponse(HttpStatus status, String message, Object content, int numberOfElement,
			Long rowCount) {
		return Response.builder().message(message).rowCount(rowCount).statusCode(status.value())
				.timestamp(new Date().getTime()).build();
